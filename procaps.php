<?php
	//incluimos el archivo que se conecta con la base de datos
...
<html>
   <head>
		...
		//funcion que envia la informacion del select a el archivo cargar2.php
	...
	<body onload="cargarjs('cargar2.php','sEst')"> 
		<div class="container">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12" style="-webkit-border-radius: 15px 15px 5px;background-image:url('img/881.png');">
									<div class="texto3">
										<p  id="estiloparticular"><b>Projected Capacitive Screens and Film</b><br>Capacitive technology comes in two forms: completely
											integrated into a TV or as a DIY applied film. The complete screens connect with an accessory computer
											via USB which communicates to the driver where the user is touching. The DIY capacitive film is applied
											to a sheet of glass and the controller board (connected via ribbon cables to the film) is also connected
											to a computer via USB. Most of the capacitive screen/film drivers available today only support the Windows
											OS due to the huge push for touch-screen interaction of Microsoft's Windows 7 and 8 graphic user interface (GUI).</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12"style="-webkit-border-radius: 15px 15px 5px;background-color:White;">
									<!-- aqui se realiza la consulta dependiendo del producto seleccionado y se muestra por pantalla-->
									...
									<div class="texto3">
										<?php 
											...
											<div class="col-md-12">
												...
												<h4>1)Select the Type of Projected Capacitive Touch Film</h4>
												
												<select id="sEst" onchange="cargarjs('cargar2.php?est='+this.value,'sDM')"></select>

												<h4>2)Select the Projected Capacitive Touch Film</h4>
