...
{		
	echo"
			<div class='panel panel-default'>
				...
				<div id='collapseOne' class='panel-collapse collapse' style='background-color:black'>
			...
			<div class='panel panel-default'  >
					...
					<div id='collapseTwo' class='panel-collapse collapse'  style='background-color:black'>
						<div class='panel-body' align='center'>
...
echo"<!-- Codigo HTML del pié de página --> 
		<div class='container'>
			...
			<br><img id='idimagen' src='img/logo.png' ></a></b></p>
		</div>
