   ...
   <head>
	...
	<body onload="cargarjs('cargar2.php','sEst')"> 
		<div class="container">
			...
			<?php menu_acordeon("touch.php","#","software.php","calculator.php","triangle.php","units.php","lens.php"); ?>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#collapseFour"><strong>SEE OUR PRODUCTS</strong></a>
						</h4>
					</div>
